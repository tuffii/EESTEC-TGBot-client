...
const Component: SolidJS.Component = () => {
  ...
  const Element: SolidJS.JSX.Element = (
    <div class={`customElement`} id={`requests`}>
      ...
      <SolidJS.Show when={acceptInvite()}>
        <div class={'blacker'}>
        <div class={'meny'}>
          <div class={'head'}>
    ...
    <SolidJS.Show when={rejectInvite()}>
        <div class={'blacker'}>
        <div class={'meny'}>
          <div class={'head'}>
            <div class={'textContainer'}>
      ...
      <div class={'header'}>
        ...
        <button
          class={'multiple'}
          onClick={(_) => {
            setRejectInvite(!rejectInvite() && GetCheckedUsers().length != 0)
          }}>
        ...
        <button
          class={'multiple'}
          onClick={(_) => {
            setAcceptInvite(!acceptInvite() && GetCheckedUsers().length != 0)
          }}>
